...
class BookVOAdapter extends TypeAdapter<BookVO> {
  ...
  BookVO read(BinaryReader reader) {
    ...
    return BookVO(
      ...
      amazonProuctUrl: fields[1] as String?,
      ...
      userViewedTime: fields[25] as String?,
...
BookVO _$BookVOFromJson(Map<String, dynamic> json) => BookVO(
      ...
      amazonProuctUrl: json['amazon_product_url'] as String?,
      ...
      buyLinks: (json['buy_links'] as List<dynamic>?)
          ...
          .toList(),
      userViewedTime: json['userViewedTime'] as String?,
      category: json['category'] as String?,
    );

Map<String, dynamic> _$BookVOToJson(BookVO instance) => <String, dynamic>{
      'age_group': instance.ageGroup,
      'amazon_product_url': instance.amazonProuctUrl,
      ...
      'userViewedTime': instance.userViewedTime,
